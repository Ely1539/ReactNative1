...
const Horoscope = () => {
  ...
  const fetchHoroscope = async () => {
    try {
      ...
      const options = {
        ...
        headers: {
          "X-RapidAPI-Key":
            "22d4712af9mshb9c6671f1dd9349p1cf740jsned5f8f3d2153",
          "X-RapidAPI-Host":
      ...
      Alert.alert(
        "Error",
        "No se pudo obtener el horóscopo. Por favor, inténtelo de nuevo más tarde."
      );
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Obtener Horóscopo" onPress={fetchHoroscope} />
